...
const Pipeline = () => {
  ...
  return (
    <main>
      ...
      <section
        id="Tanggal Pipeline"
        className="bg-blue-200 mt-4 p-4 rounded-md text-blue-600"
      >
        <p>{`Pipeline ${currentPipelineDateString}`}</p>
      </section>
      <section className="flex justify-between items-center mt-4 p-2 space-x-4 sm:space-x-0">
        <button
          className="bg-green-500 text-white text-sm p-3 rounded-md font-bold"
          onClick={() => {
